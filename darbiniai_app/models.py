...
class DarbiniaiAppEntry(models.Model):
    id = models.BigAutoField(primary_key=True)
    score = models.IntegerField()
    date_added = models.DateTimeField()
    lb = models.ForeignKey('DarbiniaiAppLeaderboard', models.DO_NOTHING, db_column='LB_id')  # Field name made lowercase.
    owner = models.ForeignKey(AuthUser, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'darbiniai_app_entry'


class DarbiniaiAppGame(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class DarbiniaiAppLeaderboard(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'darbiniai_app_leaderboard'
